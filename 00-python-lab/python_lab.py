...
three_digits_set = { x1+x2*base+x3*base**2 for x1 in digits for x2 in digits for x3 in digits }
...
base = 10
digits = set(range(10))
representation_dict = { (x1+x2*base+x3*base**2):[x3,x2,x1] for x1 in digits for x2 in digits  for x3 in digits }

## Task 26
d = {0:1000.0, 1:1200.50, 2:990}
names = ['Larry', 'Curly', 'Moe']
listdict2dict = { n:d[i] for i,n in zip(range(len(names)),names) if i in d }
